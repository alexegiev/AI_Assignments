...
# Train the AdaBoost classifier from scikit-learn
...
print(f"Accuracy: {accuracy_score(test_labels, adaboost_predictions) * 100:.2f}%")
# Calculate and print the evaluation metrics
print("AdaBoost Accuracy: ", accuracy_score(test_labels, adaboost_predictions))
print("AdaBoost Precision: ", precision_score(test_labels, adaboost_predictions, average='macro', zero_division=1))
print("AdaBoost Recall: ", recall_score(test_labels, adaboost_predictions, average='macro', zero_division=1))
print("AdaBoost F1 Score: ", f1_score(test_labels, adaboost_predictions, average='macro', zero_division=1))

# Plot learning curves
train_sizes, train_scores, test_scores = learning_curve(AdaBoostClassifier(n_estimators=50, learning_rate=0.01), train_vectors, train_labels, cv=5)
