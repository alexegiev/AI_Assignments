...
random_forest = RandomForest(n_estimators=50, max_depth=None)
...
train_sizes, train_scores, test_scores = learning_curve(RandomForest(n_estimators=50, max_depth=None), train_vectors, train_labels, cv=5)
